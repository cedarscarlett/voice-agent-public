...
class ElevenLabsTTSAdapter:
    ...
    _VOICE_MAP: dict[str, str] = {
        ...
        "theo": "ErXwobaYiN019PkySvjV",
        "megan": "EXAVITQu4vr4xnSDxMaL",
    }
    ...
    async def _run_synthesis(
        ...
        *,
        ...
        try:
            ...
            audio_stream: AsyncIterator[bytes] = self._client.text_to_speech.stream(
    ...
    def _resolve_voice(cls, voice: str) -> str:
        return cls._VOICE_MAP.get(voice.lower(), "21m00Tcm4TlvDq8ikWAM")
